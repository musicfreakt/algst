...
class mycont 
{
	...
	public:
		...
		friend void prepare_and(mycont&, mycont&, const int, int);
};

mycont::mycont(int power, int lim) : mycont()
{
...
void prepare_and(mycont& one, mycont& two, const int quantity, int lim)
{
